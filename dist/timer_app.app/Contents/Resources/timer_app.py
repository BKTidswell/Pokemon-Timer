...
def evolvePkmn(pkmn):
	evolvedForm = choice(core_pkmn_dict[pkmn.species].evolution,1)

	caughtPokemon.name = evolvedForm.species
	caughtPokemon.species = evolvedForm.species
	caughtPokemon.img = evolvedForm.img
